<?php
    ...
    "('http://src.great-site.net/laundry','$now','$location','$clientIP','')";
    // echo $insert;
    $conn->query($insert);  
    $conn->close();
...
$queryback="SELECT * FROM data where aplikasi='laundry'";
  ...
  <div class="container-login100" style="background-image: url('page/images/bg-02.webp');">
    <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
      <form action="op.php" method="post" class="login100-form validate-form">
        ...
        <span class="login100-form-title p-b-37">
          <b>Laund</b>rys</a>
          <p class="login-box-msg"> Laundry Management System<br/>Copyright © 2019 IDwares. HilmaSys</p>
        </span>
